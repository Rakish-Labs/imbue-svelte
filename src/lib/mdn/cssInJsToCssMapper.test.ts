import { cssInJsToCss } from './derived/cssInJsToCssMapper'
...
describe('cssInJsToCssMapper', () => {
  it('matches the fixture; if not, new CSS properties published or deprecated', () => {
    expect(cssInJsToCss).toEqual(fixture)
  })
})
