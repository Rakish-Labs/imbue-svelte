import { cssToCssInJs } from './derived/cssToCssInJsMapper'
...
const fixture = {
  ...
  '-moz-outline-radius': 'MozOutlineRadius',
  '-moz-outline-radius-bottomleft': 'MozOutlineRadiusBottomleft',
  '-moz-outline-radius-bottomright': 'MozOutlineRadiusBottomright',
  '-moz-outline-radius-topleft': 'MozOutlineRadiusTopleft',
  '-moz-outline-radius-topright': 'MozOutlineRadiusTopright',
...
describe('cssToCssInJsMapper', () => {
  it('matches the fixture; if not, new CSS properties likely published or deprecated', () => {
    expect(cssToCssInJs).toEqual(fixture)
  })
})
